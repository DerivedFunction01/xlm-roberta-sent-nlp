...
Original file is located at
    https://colab.research.google.com/drive/1pMHV1cz7Ib5t6-OIEDkElxQCRfC4g2Tj
...
training_args = TrainingArguments(
    ...
    eval_strategy="steps",
    save_strategy="steps",
    eval_steps=5000,  # Evaluate less frequently for speed
    save_steps=5000,
...
DEMO_SENTENCES = [
    ...
    "Ich komme aus Deutschland. Я живу в Берлине уже пять лет.",
]
